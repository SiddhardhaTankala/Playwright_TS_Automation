//Test steps for E-commerce application

//    Step1: Login to the application (URL:https://rahulshettyacademy.com/client/#/auth/login)
//        - userName: sid.tankala@gmail.com
//        - #Password: Siddhu123#
//        - Click on Login button
//        - (Assertion) Verify that the login is successful by checking the presence of a specific element on the page after login (Automation Practice on top).

//    Step2: Scan and add items or item to cart
//        - create a variable to add dyanamically the product name(s) to the cart.
//        - Click on the first item in the list of products.
//        - Click on Add to Cart button
//        - Repeat the above steps for all the item(s) in the list of products that you want to add to the cart. 
//        - (Assertion) Verify that the item(s) is added to the cart by checking the cart count or the presence of the item in the cart.

//    Step3: Place the order
//        - Click on the cart icon to view the cart.
//        - (Assertion) Verify the item(s) in the cart and price details before proceeding to checkoout.
//        - Click on the Checkout button.
//        - (Assertion) Verify that the checkout page is displayed by products list and amount details
//        - Fill in the required details for checkout (e.g., country, address, payment details etc.).
//        - (Assertion) Verify the Shipping information.
//        - Click on the Place Order button.
//        - (Assertion) Verify that the order is placed successfully by checking for a confirmation message or order summary.

//    Step4: Logout from the application
//        - Click on the Logout button.
//        - (Assertion) Verify that the user is logged out successfully by checking for the presence of the login page or a specific element on the login page.

//    Note: Use appropriate locators and assertions to ensure the reliability of the test cases. Handle any necessary waits for elements to be visible or interactable before performing actions on them.
